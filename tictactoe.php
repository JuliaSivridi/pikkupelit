...
// user send msg
	...
	// user exists
		...
		switch ($user_msg) {
			...
			// main menu -> stat
			case "/stat": case "/stat@pp_tictactoe_bot": case $lang[$ul]["menu-stat"]: {
			...
			// main menu -> help
			case "/help": case "/help@pp_tictactoe_bot": case $lang[$ul]["menu-hlp"]: {
			...
			// basic functionality {
			case "/start": case "/start@pp_tictactoe_bot": {
				trequest("sendMessage", ["chat_id" => $chat_id, 
					"text" => $lang[$ul]["hi1"].$input["message"]["from"]["first_name"].$lang[$ul]["hi2"]
						.$lang[$ul]["cmd-new"].$lang[$ul]["cmd-hl"], 
					"reply_markup" => draw_menu($lang[$ul], "main", $chat_type)]);
			...
			// main menu
			case "/main": case "/main@pp_tictactoe_bot": case $lang[$ul]["main-back"]: {
			...
			case "/links": case "/links@pp_tictactoe_bot": case $lang[$ul]["menu-links"]: {
			...
			// main menu -> settings
			case "/settings": case "/settings@pp_tictactoe_bot": case $lang[$ul]["menu-set"]: case $lang[$ul]["set-back"]: {
			...
			case "/lang": case "/lang@pp_tictactoe_bot": case $lang[$ul]["menu-lang"]: {
